...
Given a unitary matrix, U, with its entries in a defined Eucliean Domain, these algorithms find its decomposition into a sequence of generators made from "costly" gates and "cost-free" gates.

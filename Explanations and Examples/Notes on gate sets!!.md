...
- We have access to the matrices {I, X, Z, S, H, T, B} 
    ...
    - if we pick G = {T, CT} we get 75 generators. This allows to make the matrices with det != 1 and can be used for the GreedyBFS search.
...
DYADIC: #incomplete and commented out
